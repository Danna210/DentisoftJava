...
public class cita {
    ...
    public ArrayList<citagetset> consultar(){
     ...
     public boolean insertar( String odo, String fecha_ini, String fecha_fin, String hora_ini, String hora_fin){
        boolean reg=false;
        int dat;
        try {
            
            CallableStatement cStmt = cnn.prepareCall("{call SP_InsertarAgenda(?, ?, ?, ?, ?)}");    
             cStmt.setString(1, fecha_ini); 
             cStmt.setString(2, fecha_fin);
             cStmt.setString(3, hora_ini);
             cStmt.setString(4, hora_fin);
             cStmt.setString(5, odo);
