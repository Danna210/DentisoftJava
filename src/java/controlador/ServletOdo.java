...
public class ServletOdo extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("horario_mensual")!=null){
            try {
                InsertarHor(request, response);
            } catch (ParseException ex) {
                Logger.getLogger(ServletOdo.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     protected void historialpac(HttpServletRequest request, HttpServletResponse response)
       ...
       nom=request.getParameter("nom");
        ...
        processRequest(request, response);
              ...
              String odont, fecha_ini, fecha_fin, hora_ini, hora_fin ;
       ...
       fecha_ini=request.getParameter("fec");
       fecha_fin=request.getParameter("fec_fin");
       hora_ini=request.getParameter("hora_inicial");
       hora_fin=request.getParameter("hora_final");
       
       if (Integer.parseInt(fecha_ini.replaceAll("-",""))<=Integer.parseInt(fecha_fin.replaceAll("-",""))){
          if (Integer.parseInt(hora_ini)<= Integer.parseInt(hora_fin)){
            ...
            if (dat){
              ...
              JOptionPane.showMessageDialog(null, "La hora inicial debe ser menor a la hora final");
                ...
                JOptionPane.showMessageDialog(null, "La fecha inicial deber ser menor o igual a la fecha final");
            }
