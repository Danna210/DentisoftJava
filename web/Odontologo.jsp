      ...
      <div class="modal-body">
        ...
        <div class="root">
         ...
         <form action="" method="POST">
            ...
            <input type="submit" class="btn btn-outline-light ml-5" name="calendari" value="Crear agenda">
        ...
        %>
         ...
         <form action="ServletOdo" method="POST" class="Content">
            ...
            <input class="form-control" id="exampleInputEmail1" type="date" min="" name="fec_fin" required="">
            </div>
            ...
            <button type="submit" class="btn btn-primary btn-block" name="horario_mensual">Aceptar</button>
         </form>
